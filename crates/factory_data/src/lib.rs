...
pub use model::{
    ...
    PumpjackPrototype, RadarPrototype, RailCurve, RailGeometryError, RailPrototype,
    RecipePrototype, RepairToolPrototype, ResourceDistanceScalingConfig, ResourceExtraction,
    ResourceGenerationConfig, ResourcePatchGridConfig, RoboportPrototype, RobotKind,
    RobotPrototype, SolarPanelPrototype, SplitterPrototype, StartingAreaConfig,
    ...
    quarter_turn_length, roboport_coverage_bounds,
};
