...
pub use model::{
    ...
    FluidConnectionSide, FluidPrototype, FurnacePrototype, GunTurretPrototype, InserterPrototype,
    ItemAmount, ItemPrototype, MiningDrillPrototype, OffshorePumpPrototype, PumpjackPrototype,
