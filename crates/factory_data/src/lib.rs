...
pub use model::{
    ...
    NuclearReactorPrototype, OffshorePumpPrototype, PumpPrototype, PumpjackPrototype,
    RadarPrototype, RecipePrototype, RepairToolPrototype, ResourceDistanceScalingConfig,
    ResourceExtraction, ResourceGenerationConfig, ResourcePatchGridConfig, RoboportPrototype,
    RobotKind, RobotPrototype, SolarPanelPrototype, SplitterPrototype, StartingAreaConfig,
