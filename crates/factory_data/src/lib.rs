...
pub use model::{
    ...
    LocomotivePrototype, LogisticChestMode, LogisticChestPrototype, MAX_RESOURCE_RADIUS_TILES,
    MiningDrillPrototype, ModuleEffectPrototype, NuclearReactorPrototype, OffshorePumpPrototype,
    POSITION_SCALE, PumpPrototype, PumpjackPrototype, RadarPrototype, RailCurvePrototype,
    RailEndPrototype, RailHeading, RailPiecePrototype, RailPointPrototype, RailSignalKind,
