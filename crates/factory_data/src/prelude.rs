pub use crate::{
    ...
    ResourceExtraction, ResourceGenerationConfig, ResourcePatchGridConfig, SolarPanelPrototype,
    StartingAreaConfig, SteamEnginePrototype, TechnologyEffect, TechnologyId, TechnologyPrototype,
    TerrainNoiseConfig, TileId, TilePrototype, TransportBeltPrototype, UndergroundBeltPart,
